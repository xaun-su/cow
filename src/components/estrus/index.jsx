  ...
  return (
    ...
    <View className='quarantine-record-card' onClick={onClick}>
      ...
      <View className='card-header'>
        ...
        {/* 右箭头图标 */}
        <Navigator url='/recordsPack/pages/estrusRecording/index'>
      ...
      <View className='card-details'>
        <Text className='detail-item'>
          <Text className='detail-label'>发情时间预测:</Text> {quarantineUnit}
        </Text>
        <Text className='detail-item'>
          <Text className='detail-label'>时间发情预测:</Text> {quarantineType}
        </Text>
      </View>
