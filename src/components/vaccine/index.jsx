  ...
  return (
    ...
    <View className='quarantine-record-card' onClick={onClick}>
      ...
      <View className='card-header'>
        ...
        {/* 右箭头图标 */}
        <Navigator url='/recordsPack/pages/vaccineRecords/index'>
      ...
      <View className='card-details'>
        <Text className='detail-item'>
          <Text className='detail-label'>疫苗批次号:</Text> {quarantineUnit}
        </Text>
        <Text className='detail-item'>
          <Text className='detail-label'>疫苗名称:</Text> {quarantineType}
        </Text>
      </View>
