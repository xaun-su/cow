      ...
      <View className='page-content'>
        ...
        <View className='section'>
          ...
          <View className='list-item' onClick={() => handleTimeSelect('actualBreedingTime')}>
            <Text className='item-label'>实际**时间</Text>
             {/* TODO: 替换为日期选择器 */}
          ...
          {/* 预计**时间 */}
          {/* 这里应该是一个日期选择器 */}
          <View className='list-item' onClick={() => handleTimeSelect('expectedBreedingTime')}>
            <Text className='item-label'>预计**时间</Text>
             {/* TODO: 替换为日期选择器 */}
            <Text className={`item-value ${!formData.expectedBreedingTime && 'placeholder'}`}>
              {formData.expectedBreedingTime || '请选择时间'}
            </Text>
          </View>
        </View>
